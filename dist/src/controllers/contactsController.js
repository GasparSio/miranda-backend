...
exports.contactsController.get("/:contactId", async (req, res) => {
    try {
...
exports.contactsController.delete("/:contactId", async (req, res) => {
    try {
...
exports.contactsController.put("/:contactId", async (req, res) => {
    try {
